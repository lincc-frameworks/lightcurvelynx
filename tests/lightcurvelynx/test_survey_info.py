...
def test_create_survey_info(passbands_dir):
    ...
    # Create the survey info with the defaults (None for both passband group and noise model).
    survey_info = SurveyInfo(obstable=ops_data)
    ...
    assert survey_info_full.noise_model is noise_model
