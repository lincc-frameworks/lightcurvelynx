...
All top level design, including control flow and class structure, was designed by humans. GitHub Copilot (using Claude Sonnet 4, GPT-5.3-Codex, and auto settings) was used during the development of the software for online suggestions and small changes. All code changes, regardless of author, were reviewed by humans. No generative AI tools were used in the writing of this manuscript.
